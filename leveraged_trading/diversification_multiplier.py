...
def get_diversification_multiplier(forecasts_data: pd.DataFrame,
    ...
    '''
        Calculate the diversification multiplier for a given forecast data and weight
        
        When forecasts are weighted, the combined result will be less volatile than the individual forecasts.
